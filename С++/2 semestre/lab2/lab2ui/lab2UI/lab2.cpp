...
void lab2ui::on_Button_Clear_clicked()
{
    if(ui->ChooseButton->currentIndex() == 0) {
        this->MainArr.Clear();
    } else if(ui->ChooseButton->currentIndex() == 1){
...
void lab2ui::on_Button_BackSpace_clicked()
{
...
void lab2ui::on_Button_Tests_clicked()
{

}


void lab2ui::on_Button_ToIndex_clicked()
{
...
void lab2ui::on_Button_GetSize_clicked()
{
    if(ui->ChooseButton->currentIndex() == 0)
...
void lab2ui::on_ChooseButton_currentIndexChanged(int index)
{
    Label_update();
}


void lab2ui::on_Button_Get_clicked()
{
...
void lab2ui::on_Button_Set_clicked()
{
...
void lab2ui::on_Button_PopFrom_clicked()
{
    int index = ui->Index_label->text().toInt();
    try {
        if(ui->ChooseButton->currentIndex() == 0)
...
void lab2ui::on_Button_InsertAt_clicked()
{
    if(ui->Main_label->text().isEmpty()) {
        return;
    }
...
void lab2ui::on_Button_GetFirst_clicked()
{
    long long int value;
    try {
        if(ui->ChooseButton->currentIndex() == 0)
...
void lab2ui::on_Button_GetLast_clicked()
{
    long long int value;
    try {
        if(ui->ChooseButton->currentIndex() == 0)
...
void lab2ui::on_Button_PushFront_clicked()
{
    if(ui->Main_label->text().isEmpty()) {
        return;
    }
...
void lab2ui::on_Button_PushBack_clicked()
{
    if(ui->Main_label->text().isEmpty()) {
        return;
    }
...
void lab2ui::on_Button_PopFront_clicked()
{
    try {
        if(ui->ChooseButton->currentIndex() == 0)
...
void lab2ui::on_Button_PopBack_clicked()
{
    try {
        if(ui->ChooseButton->currentIndex() == 0)
