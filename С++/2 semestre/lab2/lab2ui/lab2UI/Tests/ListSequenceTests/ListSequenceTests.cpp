...
TEST(ListSequenceTests, OperatorPlus) {
    ...
    lab2::ListSequence<int> list3 = *dynamic_cast<const lab2::ListSequence<int> *>(list1 + list2);
    ASSERT(list3.GetSize() == 10);
    for (int i = 0; i < 10; i++) {
        ASSERT(list3.Get(i) == i + 1);
    }
    list1 = *dynamic_cast<const lab2::ListSequence<int> *>(list1 + list1);
    ASSERT(list1.GetSize() == 10);
    for (int i = 0; i < 10; i++) {
        ASSERT(list1.Get(i) == i % 5 + 1);
    }
}
...
TEST(ListSequenceTests, Concat) {
    ...
    list1 = *dynamic_cast<const lab2::ListSequence<int> *>(list1.Concat(list1));
    ASSERT(list1.GetSize() == 10);
    for (int i = 0; i < 10; i++) {
        ASSERT(list1.Get(i) == i % 5 + 1);
    }
...
TEST(ListSequenceTests, Map) {
    ...
    lab2::ListSequence<int> list2 = *dynamic_cast<const lab2::ListSequence<int> *>(list.Map(Square));
    ASSERT(list2.GetSize() == 5);
    for (int i = 0; i < 5; i++) {
